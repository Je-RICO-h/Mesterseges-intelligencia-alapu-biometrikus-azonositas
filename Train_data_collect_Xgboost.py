from Logging.Keyboard_Logger_XgBoost import KeyLogger
import time
...
model_path = {
    'model_path':'Trained_Model/XgBoost/xgboost_model.json',
    'le_path': 'Trained_Model/XgBoost/xgboost_label_encoder.joblib',
    'ohe_path': 'Trained_Model/XgBoost/xgboost_ohe_cols.npy'
}
